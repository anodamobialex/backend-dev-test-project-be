...
var Database = /** @class */ (function () {
    ...
    Database.prototype.getConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            var CONNECTION_NAME, connection, connectionOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        CONNECTION_NAME = 'default';
                        if (!this.connectionManager.has(CONNECTION_NAME)) return [3 /*break*/, 4];
                        console.log("Database.getConnection()-using existing connection::: " + CONNECTION_NAME);
                        return [4 /*yield*/, this.connectionManager.get(CONNECTION_NAME)];
                    case 1:
                        connection = _a.sent();
    ...
    Database.prototype.getRepository = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            var connection;
            return __generator(this, function (_a) {
                switch (_a.label) {
